    ...
    <section>
      ...
      >
        <div className="flex flex-col justify-center items-center lg:mb-12 mb-8">
          ...
          <div className="w-10 h-2 mt-1 rounded-2xl bg-green-600"></div>
        </div>
        ...
        <button
          type="submit"
          className="hover:bg-green-500 hover:text-white border rounded-full border-gray-300 shadow-md px-4 py-2 transition duration-500"
          disabled={loading}
        >
