...
export default function UserCard() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
          <div title="User" className="bg-gray-300 text-green-900 transition duration-700 ease-in-out hover:animate-pulse flex items-center justify-center text-2xl font-bold w-10 h-10 rounded-full">
