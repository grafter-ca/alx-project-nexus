...
import Stats from "@/component/common/Stats";
      ...
      <section className="py-6 block lg:flex">
        ...
        <article className="w-full lg:w-1/2 ml-0 lg:ml-6">
          <header className="flex justify-between items-center mb-10">
            <button className="bg-green-700 hover:bg-green-800 text-gray-100 hover:text-gray-50 transition duration-700 py-1 px-2 rounded-xl">
              {product.categoryId}
            </button>
            <div className="flex space-x-6">
              <Heart
                size={32}
                className="hover:text-green-900 hover:bg-gray-300 rounded-full p-2"
              />
              <Share2
                size={32}
                className="hover:text-green-900 hover:bg-gray-300 rounded-full p-2"
          ...
          <section>
            ...
            <div>
              <h1 className="text-[25px] text-green-600 py-4 font-medium">
                In Stock
              </h1>
